...
How to install:
  ...
  To install this game on windows, you must first press the green code button and press download zip. After that, go to file explorer and find the file and extract the folder. After extracting, all you have to do is run index.html in the browser (Ctrl + O).
